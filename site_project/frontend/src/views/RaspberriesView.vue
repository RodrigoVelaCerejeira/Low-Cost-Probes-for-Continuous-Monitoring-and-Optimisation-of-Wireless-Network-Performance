<template>
  <div
    class="min-h-screen bg-gradient-to-b from-[#17072b] via-[#2c0e44] to-[#3a0d5b] flex items-center justify-center p-8">
    <div
      ...
      <div v-if="selectedRaspberry" class="mt-6 p-6 bg-indigo-50 rounded-xl shadow-inner">
        <ul class="list-disc list-inside text-lg text-gray-800">
          ...
          <li class="text-lg"><strong>Ultimo_Registo:</strong> {{ selectedRaspberry.ultimo_registro }}</li>
        </ul>
      </div>
